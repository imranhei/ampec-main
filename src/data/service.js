...
const data = {
  "cable-assembly": {
    ...
    description:
      "Cable assembly is the process of creating custom cables and harness by combining wires, connectors, and other components. These assemblies serve as the backbone of modern technology in Australia, ensuring that data, power, and signals flow seamlessly between devices. We at Ampec Technologies are passionate about precision and connectivity in cable harness. With years of experience and a dedicated team of experts, we specialize in cable assembly solutions that drive innovation and enable seamless communication in Australia.",
    banner: banner_cable_assembly,
    contentImg: img_content,
    subTitle: "Experience You Can Trust",
    subDesc:
      "Our experience is as diverse as the unique needs of our clients in Australia. Whether you're in need of thousands of identical custom cables or complex wiring harness and assemblies containing over 50 custom cables and connections within each product, we have the knowledge and capability to deliver. Our portfolio is a testament to our ability to meet your demands in cable harness, no matter how intricate they may be. When it comes to flexible, responsive, and quality-guaranteed cable assemblies in Australia, Ampec Technologies is the name you can trust. Contact us today, and let's discuss how we can create custom solutions that exceed your expectations in cable harness. Your success is our mission, and we're ready to make it happen.",
    point_1_title: "Bespoke Cable Assemblies from Scratch",
    point_1_desc:
      "We understand that each project is unique in Australia, and off-the-shelf solutions may not always fit. That's why we take pride in our ability to build custom cables from scratch. Our team of expert engineers and technicians will work closely with you to design and manufacture cable assemblies that are tailored to your exact specifications in Australia.This level of customization ensures that your cables will perform optimally in your specific application with our cable harness expertise.",
    point_2_title: "Custom Wiring Harnesses",
    point_2_desc:
      "In addition to custom cables, we specialize in crafting custom wiring harnesses in Australia. These harnesses are meticulously designed and manufactured to integrate seamlessly into your systems, ensuring that your devices and machinery function smoothly and efficiently.We have the expertise to create complex wiring solutions, delivering the connectivity your project demands through our cable harness capabilities.",
    point_3_title: "Complete Product Integration",
    point_3_desc:
      "Our commitment to your success in Australia extends beyond just cables and wiring harnesses.This means we can assemble and connect any mix of cabling that your product requires, providing you with a turnkey solution in cable harness. Whether it's for industrial machinery, consumer electronics, or any other application, we have the expertise and facilities to bring your product to life with our cable harness solutions.",
