  ...
  return (
    <div className="flex flex-col items-center space-y-6 py-10" ref={quotationRef}>
      ...
      <div className="sm:space-y-4 space-y-2 lg:w-[850px] sm:w-[700px] w-[360px] px-5 font-exo text-amBlue">
        ...
        <textarea className="w-full lg:h-56 sm:h-44 h-24 max-h-80 sm:rounded-lg rounded border border-gray-400 p-2" onChange={(e) => setCableDescription(e.target.value)}></textarea>
      </div>
      <div className="sm:space-y-4 space-y-2 lg:w-[850px] sm:w-[700px] w-[360px] px-5 font-exo text-amBlue">
        <p className="lg:text-2xl sm:text-xl tracking-wide">
          Date Required :
        </p>
        <textarea className="w-full lg:h-24 sm:h-44 h-16 max-h-80 sm:rounded-lg rounded border border-gray-400 p-2" onChange={(e) => setDateRequired(e.target.value)}></textarea>
      </div>
