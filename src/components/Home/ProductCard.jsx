...
const ProductCard = ({ product }) => {
    return (
        <Link to={product.link} className='md:w-[300px] sm:w-[280px] w-[300px] h-[440px] relative rounded-lg overflow-hidden shadow-md group outline hover:outline-3 outline-transparent hover:outline-blue-900 duration-500 hover:-mt-8'>
            <svg
