...
import defence_03 from "../../../assets/Industries/defence_03.png";
import defence_04 from "../../../assets/Industries/defence_04.png";
  ...
  return (
    <div className="w-full py-20 container mx-auto lg:px-20 px-10 text-amBlue">
      ...
      <p className="font-khula sm:text-base text-sm pb-6">
        ...
        built to perform. We understand that reliability is paramount in defense
      ...
      <p className="font-khula sm:text-base text-sm pb-6">
        ...
        that your defense systems benefit from the most advanced components
