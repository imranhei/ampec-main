...
const CallUs = () => {
  return (
    <div>
      <p className="container mx-auto text-center sm:py-6 sm:mt-8 mt-4 py-5 font-khula lg:text-5xl sm:text-4xl text-xl text-amBlue font-semibold tracking-wider">
        Call us now on :{" "}
