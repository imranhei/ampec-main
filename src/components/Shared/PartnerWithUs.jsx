...
const PartnerWithUs = () => {
  return (
    <div className="flex w-full flex-col items-center">
      ...
      <div className="text-center text-amBlue sm:text-base text-sm font-semibold lg:leading-10 leading-6 tracking-wide font-khula sm:pb-16 pb-8 xl:w-[1260px] px-10">
